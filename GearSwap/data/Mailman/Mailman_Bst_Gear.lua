function user_job_setup()
    ...
    gear.PHYKumbha1 = {
        name = "Kumbhakarna",
        augments = {'Pet: Attack+20 Pet: Rng.Atk.+20', 'Pet: "Dbl.Atk."+4 Pet: Crit.hit rate +4', 'Pet: TP Bonus+180'}
    }
    gear.PHYKumbha2 = {
        name = "Kumbhakarna",
    ...
    gear.PDTMABKumbha = {
        name = "Kumbhakarna",
        augments = {'Pet: "Mag.Atk.Bns."+19', 'Pet: Phys. dmg. taken -5%', 'Pet: TP Bonus+180'}
    }
    gear.MABKumbha = {
        name = "Kumbhakarna",
...
function init_gear_sets()
    ...
    sets.midcast.Helix.Resistant = set_combine(sets.midcast['Elemental Magic'], {})
