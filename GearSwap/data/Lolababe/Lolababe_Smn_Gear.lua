...
function user_job_setup()
    ...
    gear.magic_jse_back = { name = "Campestres's Cape", augments = { 'Pet: M.Acc.+20 Pet: M.Dmg.+20', 'Eva.+20 /Mag. Eva.+20', 'Pet: Mag. Acc.+10', '"Fast Cast"+10', } }
    gear.phys_jse_back = { name = "Campestres's Cape", augments = { 'Pet: Acc.+20 Pet: R.Acc.+20 Pet: Atk.+20 Pet: R.Atk.+20', 'Accuracy+20 Attack+20', 'Pet: Accuracy+10 Pet: Rng. Acc.+10', 'Pet: "Regen"+10', } }
...
function init_gear_sets()
    ...
    sets.precast.FC.Cure = set_combine(sets.precast.FC, {
        -- main = "Serenity", sub = "Clerisy Strap +1" 
    })
    ...
    sets.midcast.Pet.MagicalBloodPactRage.Acc = {
        -- head = "C. Palug Crown", feet = "Convo. Pigaches +3" 
    }
    ...
    -- Weapons sets
    sets.weapons.Nirvana = { main = "Nirvana", sub = "Enki Strap" }
