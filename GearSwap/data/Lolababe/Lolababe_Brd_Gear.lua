...
function init_gear_sets()
    ...
    sets.weapons.DualQutrub = {
        main = "Qutrub Knife",
        sub = "Ceremonial Dagger"
    }
    sets.weapons.DualCarnwenhan = {
        main = "Carnwenhan",
        sub = "Centovente"
    }
    ...
    sets.precast.FC = {
        ...
        hands = {
            name = "Gende. Gages +1",
            augments = {'Phys. dmg. taken -3%', 'Magic dmg. taken -2%', 'Song spellcasting time -4%'}
        },
        legs = "Volte Brais",
    ...
    sets.precast.WS = {
        range = {
            name = "Linos",
            augments = {'Accuracy+16', 'Weapon skill damage +3%', 'STR+6 CHR+6'}
        },
        head = {
            name = "Nyame Helm",
            augments = {'Path: B'}
    ...
    sets.engaged = {
        range = {
            name = "Linos",
            augments = {'Accuracy+15 Attack+15', '"Store TP"+3', 'Quadruple Attack +3'}
        },
        head = "Bunzi's Hat",
        body = "Ashera Harness",
...
state.Weapons:options('None', 'Naegling', 'Aeneas', 'Carnwenhan', 'DualQutrub', 'DualCarnwenhan', 'DualWeapons',
    'DualNaegling', 'DualTauret', 'DualAeolian')
