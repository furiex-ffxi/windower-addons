...
gear.gada_enhancing_club = { name="Gada", augments={'Indi. eff. dur. +11','VIT+2','Mag. Acc.+6','"Mag.Atk.Bns."+11',}}
gear.gada_indi_club = { name="Gada", augments={'Indi. eff. dur. +11','VIT+2','Mag. Acc.+6','"Mag.Atk.Bns."+11',}}
...
gear.herculean_qa_hands = {name="Herculean Gloves", augments={'Sklchn.dmg.+4%','Pet: "Regen"+4','Quadruple Attack +3','Accuracy+4 Attack+4',}}
...
gear.herculean_ta_feet = {name="Herculean Boots", augments={'Weapon Skill Acc.+15','"Triple Atk."+3','Accuracy+4 Attack+4','Mag. Acc.+15 "Mag.Atk.Bns."+15',}}
...
gear.odyssean_fc_legs = { name="Odyssean Cuisses", augments={'"Mag.Atk.Bns."+16','"Fast Cast"+6','INT+4',}}
