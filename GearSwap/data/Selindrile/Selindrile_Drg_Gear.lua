...
function init_gear_sets()
	...
	sets.idle = {ammo="Staunch Tathlum +1",
		...
		body="Tartarus Platemail",hands="Sulev. Gauntlets +2",ring1="Defending Ring",ring2="Murky Ring",
	...
	sets.idle.Refresh = {ammo="Staunch Tathlum +1",
		...
		body="Jumalik Mail",hands="Sulev. Gauntlets +2",ring1="Defending Ring",ring2="Murky Ring",
		back="Shadow Mantle",waist="Flume Belt +1",legs="Carmine Cuisses +1",feet="Amm Greaves"}
